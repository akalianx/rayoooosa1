...
// (^~_~^) LGP End
	...
	{
		clif_displaymessage(sd->fd, "Seguridad ACTIVADA: Usa @seguridad para m?s opciones.");
		sd->state.seguridad = 1;
	}
	else
		clif_displaymessage(sd->fd, "Seguridad DESACTIVADA: Usa @seguridad para m?s opciones.");
